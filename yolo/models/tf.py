...
Usage:
    $ python models/tf.py --weights yolov5s.pt --cfg arcme.yaml

Export int8 TFLite models:
    $ python models/tf.py --weights yolov5s.pt --cfg models/arcme.yaml --tfl-int8 \
...
For TensorFlow.js:
    $ python models/tf.py --weights yolov5s.pt --cfg models/arcme.yaml --img 320 --tf-nms --agnostic-nms
...
class tf_Model():
    def __init__(self, cfg='arcme.yaml', ch=3, nc=None, model=None):  # model, input channels, number of classes
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg', type=str, default='arcme.yaml', help='cfg path')
