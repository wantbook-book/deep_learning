...
def parse_opt(known=False):
    ...
    parser.add_argument('--name', default='expchanged', help='save to project/name')
    parser.add_argument('--cfg', type=str, default='arcme.yaml', help='model.yaml path')
